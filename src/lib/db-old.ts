...
export async function createConversion(data: NewConversion): Promise<Conversion> {
  ...
  return {
    ...
    inputUrl: conversion.input_url,
    outputUrl: conversion.output_url,
    method: conversion.method,
    tokens: conversion.tokens,
    hasStructuredData: conversion.has_structured_data,
    createdAt: new Date(conversion.created_at),
    completedAt: conversion.completed_at ? new Date(conversion.completed_at) : null,
  };
}
